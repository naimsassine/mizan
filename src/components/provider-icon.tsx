...
// on cards and lists. Providers with a brand mark in PROVIDER_LOGOS render the logo
// (tinted via currentColor); the rest fall back to the monogram.
...
// Official single-color brand marks. Drawn with currentColor so they pick up the per-provider
// text color from PROVIDER_META, keeping them consistent with the rest of the palette.
const PROVIDER_LOGOS: Record<string, ReactNode> = {
  ...
  anthropic: (
    <svg viewBox="0 0 24 24" fill="currentColor" className="h-4 w-4" aria-hidden>
      <path d="M17.3041 3.541h-3.6718l6.696 16.918H24ZM6.6959 3.541 0 20.459h3.7442l1.3693-3.5527h7.0052l1.3693 3.5528h3.7442L10.5363 3.541Zm-.3712 10.2566 2.2914-5.9456 2.2914 5.9456Z" />
    </svg>
  ),
}
